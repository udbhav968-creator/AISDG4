...
import { Shield, Bus, Navigation, Radar, Radio, ShieldAlert, Calculator, UserCheck, Menu, X, Activity, Cpu, Sparkles } from 'lucide-react';
    ...
    <>
      ...
      <div className="bg-zinc-950 border-b border-zinc-850 px-4 py-1.5 text-[11px] font-mono text-zinc-400 flex items-center justify-between overflow-x-auto whitespace-nowrap">
        ...
        <div className="hidden md:flex items-center gap-3">
          <span className="text-purple-300 flex items-center gap-1 font-semibold">
            ...
            Google Gemini 1.5 & Claude 3.5 AI Active
          </span>
          <span className="text-zinc-600">|</span>
      ...
      <header className="sticky top-0 z-40 glass-nav">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 h-16 flex items-center justify-between gap-2">
          ...
          <nav className="hidden lg:flex items-center gap-1 bg-zinc-900/90 p-1.5 rounded-xl border border-zinc-800 text-xs">
            {tabs.map((t) => {
              const Icon = t.icon;
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-semibold flex items-center gap-1.5 transition-all duration-200 ${
                    isActive
                      ? 'bg-gradient-to-r from-pink-600 to-purple-600 text-white shadow-lg shadow-pink-600/25 scale-[1.02]'
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="btn-vibrant-pink px-4 py-2 text-white font-extrabold text-xs rounded-xl flex items-center gap-2"
            >
